...
- (void)drawInView:(PGAlertView *)anAlertView
{
	...
	[s appendBezierPathWithArcWithCenter:NSMakePoint(100, 155) radius:60 startAngle:90 endAngle:270 clockwise:NO];
	[s appendBezierPathWithArcWithCenter:NSMakePoint(150, 90) radius:5 startAngle:90 endAngle:0 clockwise:YES];
	...
	[s appendBezierPathWithArcWithCenter:NSMakePoint(150, 120) radius:5 startAngle:0 endAngle:270 clockwise:YES];
	[s appendBezierPathWithArcWithCenter:NSMakePoint(100, 155) radius:40 startAngle:270 endAngle:90 clockwise:YES];
	[s appendBezierPathWithArcWithCenter:NSMakePoint(200, 155) radius:40 startAngle:90 endAngle:0 clockwise:YES];
	[s appendBezierPathWithArcWithCenter:NSMakePoint(250, 155) radius:10 startAngle:180 endAngle:0 clockwise:NO];
	[s appendBezierPathWithArcWithCenter:NSMakePoint(200, 155) radius:60 startAngle:0 endAngle:90 clockwise:NO];
	[s fill];
}
