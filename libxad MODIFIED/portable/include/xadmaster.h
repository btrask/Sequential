...
#define ti_DataP ti_Data.P[1]
#else
#define ti_DataP ti_Data.P[0]
#endif
...
#ifdef __BIG_ENDIAN__
#define xhp_CommandDataP xhp_CommandData.P[1]
#else
#define xhp_CommandDataP xhp_CommandData.P[0]
#endif
...
#ifdef __BIG_ENDIAN__
#define xai_InPosP xai_InPos.P[1]
#else
#define xai_InPosP xai_InPos.P[0]
#endif
