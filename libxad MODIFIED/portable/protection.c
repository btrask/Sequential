...
FUNCxadConvertProtection /* xadTAGPTR tags */
{
  ...
  while((ti = NextTagItem(&ti2)))
  {
    ...
    case XAD_PROTMSDOS: dosprot = ti->ti_Data.S; flags |= XADFIF_DOSPROTECTION;
      ...
      break;
    case XAD_PROTFILEINFO: fi = (struct xadFileInfo *) ti->ti_DataP;
  ...
  while((ti = NextTagItem(&ti2)))
  {
    ...
    case XAD_GETPROTAMIGA:
      ...
      {
        *((xadUINT32 *) ti->ti_DataP) = prot; ++numres;
      }
      break;
    case XAD_GETPROTUNIX:
      ...
      {
        *((xadUINT32 *) ti->ti_DataP) = unxprot; ++numres;
      }
      break;
    case XAD_GETPROTMSDOS:
      ...
      {
        *((xadUINT32 *) ti->ti_DataP) = dosprot; ++numres;
      }
      break;
    case XAD_GETPROTFILEINFO:
      ...
      {
        fi = (struct xadFileInfo *) ti->ti_DataP; ++numres;
        fi->xfi_Flags |= flags;
