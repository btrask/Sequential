...
FUNCxadConvertDates /* xadTAGPTR tags */
{
  ...
  while((ti = NextTagItem(&ti2)))
  {
    ...
    case XAD_DATEDATESTAMP: ++dats; datsp = (struct MyDateStamp *)
      ti->ti_DataP; break;
    case XAD_DATEXADDATE: ++xad; xadp = (struct xadDate *) ti->ti_DataP;
      break;
    case XAD_DATECLOCKDATA: ++cd; cdp = (struct MyClockData *) ti->ti_DataP;
      break;
    ...
    case XAD_DATECPM: ++cpm; cpmdate = (xadUINT8 *) ti->ti_DataP; break;
    case XAD_DATEISO9660: ++iso; isodate = (xadUINT8 *) ti->ti_DataP; break;
  ...
  while((ti = NextTagItem(&ti2)))
  {
    ...
    case XAD_GETDATEUNIX:
      *((xadUINT32 *)ti->ti_DataP) = xadtosec(&xadi, 1970);
      break;
    case XAD_GETDATEAMIGA:
      *((xadUINT32 *)ti->ti_DataP) = xadtosec(&xadi, 1978);
      break;
    case XAD_GETDATEMAC:
      *((xadUINT32 *)ti->ti_DataP) = xadtosec(&xadi, 1904);
      break;
#ifdef AMIGA
    case XAD_GETDATEDATESTAMP:
      {
        struct DateStamp *d;
        d = (struct DateStamp *) ti->ti_DataP;
    ...
    case XAD_GETDATEXADDATE:
      xadCopyMem(XADM &xadi, ti->ti_DataP, sizeof(struct xadDate));
      break;
#ifdef AMIGA
    case XAD_GETDATECLOCKDATA:
      {
        struct ClockData *c;
        c = (struct ClockData *) ti->ti_DataP;
    ...
    case XAD_GETDATEMSDOS:
      {
        ...
        if(xd.xd_Year > 1980+127) /* 31.12.2107 23:59:59 */
          *((xadUINT32 *)ti->ti_DataP) = (xadUINT32) (((((((((127<<4)+12)<<5)+31)<<5)+23)<<6)+59)<<5)+(59/2);
        else if(xd.xd_Year < 1980) /* 1.1.1980 00:00:00 */
          *((xadUINT32 *)ti->ti_DataP) = (((((((((0<<4)+1)<<5)+1)<<5)+0)<<6)+0)<<5)+0;
        else
          *((xadUINT32 *)ti->ti_DataP) = ((((((((((xd.xd_Year-1980)<<4)+xd.xd_Month)<<5)+
    ...
    case XAD_GETDATECPM2:
      {
        ...
        if(xd.xd_Year < 1978) /* 1.1.1978 00:00:00 */
          *((xadUINT32 *)ti->ti_DataP) = (((((1<<5)+0)<<6)+0)<<5)+0;
        else
        {
          timeval = xadtodays(&xd, 1978)+1;
          if(timeval > 0xFFFF)
            *((xadUINT32 *)ti->ti_DataP) = (xadUINT32) (((((0xFFFF<<5)+23)<<6)+59)<<5)+(59/2);
          else
            *((xadUINT32 *)ti->ti_DataP) = (((((timeval<<5)+xd.xd_Hour)<<6)+xd.xd_Minute)<<5)+(xd.xd_Second/2);
        }
      }
      break;
    case XAD_GETDATECPM:
      cpmdate = (xadUINT8 *) ti->ti_DataP;
